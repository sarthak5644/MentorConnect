...
export default function StudentChat() {
  ...
  if (!chats?.length) return <EmptyState icon={MessageSquare} title="No conversations yet" description="Chats start once a mentor accepts your request." />;
  ...
  return (
    <div className="grid h-[calc(100vh-8rem)] grid-cols-1 gap-4 sm:grid-cols-3">
      <div className="sm:col-span-1 overflow-y-auto">
        <ChatList chats={chats} activeChatId={activeChatId} onSelect={(id) => navigate(`/student/chat/${id}`)} />
      </div>
